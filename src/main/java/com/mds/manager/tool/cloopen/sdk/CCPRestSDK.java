 ...
 */
package com.mds.manager.tool.cloopen.sdk;

import com.google.gson.JsonArray;
import com.google.gson.JsonElement;
import com.google.gson.JsonObject;
import com.google.gson.JsonParser;
import com.mds.manager.tool.cloopen.utils.CcopHttpClient;
import com.mds.manager.tool.cloopen.utils.DateUtil;
import com.mds.manager.tool.cloopen.utils.EncryptUtil;
import com.mds.manager.tool.cloopen.utils.LoggerUtil;
...
public class CCPRestSDK {
				...
				public HashMap<String, Object> voiceVerify(String verifyCode, String to, String displayNum, String playTimes,
				                                           String respUrl, String lang, String userData, String welcomePrompt,
				                                           String playVerifyCode, String maxCallTime) {
								HashMap<String, Object> validate = accountValidate();
								if (validate != null)
												return validate;
				...
				public HashMap<String, Object> landingCall(String to, String mediaName, String mediaTxt, String displayNum,
				                                           String playTimes, String respUrl, String userData, String txtSpeed,
				                                           String txtVolume, String txtPitch, String txtBgsound, String playMode) {
								HashMap<String, Object> validate = accountValidate();
								if (validate != null)
												return validate;
								if (isEmpty(to))
				...
				private HttpRequestBase getHttpRequestBase(int get, String action) throws NoSuchAlgorithmException,
